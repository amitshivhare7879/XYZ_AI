...
class ConversationOrchestrator:
    ...
    def _handle_conversational_turn(
        ...
        # -------------------------------------------------------------------
        # E.2 Class Strength, Enrollment & Total Student Count Queries
        # -------------------------------------------------------------------
        is_student_count_query = any(phrase in msg_lower for phrase in [
            "how many students", "number of students", "class strength", "total students", "students in class",
            "students in the class", "students in my class", "students enrolled", "class size", "batch size",
            "class count", "enrolled students", "total enrollment", "how many children", "how many kids",
